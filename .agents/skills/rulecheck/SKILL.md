...
- **Do NOT update project memory** — the agent maintains its own memory at `.Codex/agent-memory/rulecheck-agent/`. Do not duplicate run results into your project memory.
