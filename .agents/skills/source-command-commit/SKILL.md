...
Context:
- Updated .Codex/rules/orchestrator.md with retry conventions
- Added .Codex/commands/debug-session.md for session state inspection
...
- `.Codex/rules/` — on-demand conventions added, updated, or removed
- `.Codex/commands/` — slash commands created or modified
- `.Codex/docs/` — reference docs added or updated
