...
```markdown
Read .codex/agents/gsd-framework-selector.md for instructions.
...
```bash
cp ".codex/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read .codex/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read .codex/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read .codex/agents/gsd-eval-planner.md for instructions.
