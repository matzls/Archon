...
<execution_context>
@.codex/get-shit-done/workflows/spike.md
@.codex/get-shit-done/workflows/spike-wrap-up.md
...
- If it is `--wrap-up`: strip the flag, execute the spike-wrap-up workflow from @.codex/get-shit-done/workflows/spike-wrap-up.md.
- Otherwise: pass all of {{GSD_ARGS}} as the idea to the spike workflow from @.codex/get-shit-done/workflows/spike.md end-to-end.
