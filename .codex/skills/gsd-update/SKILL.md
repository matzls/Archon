...
- Otherwise: **Follow the update workflow** from `@.codex/get-shit-done/workflows/update.md`.
...
@.codex/get-shit-done/workflows/sync-skills.md
@.codex/get-shit-done/workflows/reapply-patches.md
</execution_context_extended>
